...
//                   className="relative w-3/4 sm:w-2/3 md:w-4/5 h-auto object-contain drop-shadow-xl"
//                   loading="eager"
//                   fetchpriority="high"
//                   onError={(e) => {
...
//               {/* Stats Card */}
//               <div className={`absolute -bottom-6 left-0 backdrop-blur-sm px-4 py-3 
//                             shadow-xl rounded-lg border hidden lg:flex items-center gap-3 min-w-[160px] animate-up-down ${
//                               isDarkMode 
//                                 ? 'bg-gray-800/95 border-gray-700' 
//                                 : 'bg-white/95 border-gray-200'
//                             }`}
