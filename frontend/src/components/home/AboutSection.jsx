...
const AboutSection = () => {
  ...
  const features = [
    {
      ...
      subtitle: aboutData?.years ? `${aboutData.years} experience` : "Lab tested products",
      value: aboutData?.years
    },
    {
      icon: FiZap,
      title: "Products",
      subtitle: aboutData?.products ? `${aboutData.products}+ items` : "Latest technology",
      value: aboutData?.products
    },
    {
      icon: FiUsers,
      title: "Happy Customers",
      subtitle: aboutData?.customers ? `${aboutData.customers}+ served` : "10k+ customers",
      value: aboutData?.customers
    },
    {
      icon: FiHeadphones,
      title: "Customer Support",
      subtitle: aboutData?.support || "24/7 support",
  ...
  return (
    <section className={`relative overflow-hidden py-20 transition-opacity duration-700 ${
      isDarkMode ? 'bg-gray-900' : 'bg-white'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div ref={contentRef} className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center opacity-0">
          ...
          <div className="order-2 md:order-2 space-y-6">
            ...
            {/* Stats/Features - Dynamic from API */}
            <div className={`grid grid-cols-2 gap-4 pt-4 border-t transition-colors duration-500 ${
              isDarkMode ? 'border-gray-800' : 'border-gray-200'
            }`}>
